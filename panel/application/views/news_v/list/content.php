...
<div class="col-md-12">
				<h4 class="m-b-lg">
					Haber Listesi
				<a href="<?php echo "news/new_form"; ?>" class="btn btn-outline btn-primary btn-xs pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
				</h4>
			</div><!-- END column -->
<div class="col-md-12">
				...
				<div class="alert alert-info text-center">
					<p>Burada herhangi bir veri bulunmamaktadır. Eklemek için <a href="<?php echo "news/new_form"; ?>">tıklayınız</a></p>
				</div>
						...
						<tbody class="sortable" data-url="<?php echo base_url("news/rankSetter"); ?>">
							...
							<tr id="ord-<?php echo $item->id; ?>">
								...
								<td>
									...
									<a href="<?php echo "news/update_form/$item->id"; ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a>
								</td>
							</tr>
