...
<div class="col-md-12">
				<h4 class="m-b-lg">
					E-posta Listesi
				<a href="<?php echo "emailsettings/new_form"; ?>" class="btn btn-outline btn-primary btn-xs pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
				</h4>
			</div><!-- END column -->
<div class="col-md-12">
				...
				<div class="alert alert-info text-center">
					<p>Burada herhangi bir veri bulunmamaktadır. Eklemek için <a href="<?php echo "emailsettings/new_form"; ?>">tıklayınız</a></p>
				</div>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center w150">
									<button 
										data-url="<?php echo "emailsettings/delete/$item->id"; ?>" 
										class="btn btn-sm btn-danger btn-outline remove-btn">
										<i class="fa fa-trash"></i> Sil
									</button>
									<a href="<?php echo "emailsettings/update_form/$item->id"; ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a>
								</td>
							</tr>
